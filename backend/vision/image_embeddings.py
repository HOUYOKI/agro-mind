"""
CLIP image embedding module for image retrieval.
"""
...
class CLIPEmbeddings(Embeddings):
    ...
    def _initialize(self):
        ...
        self.normalize = getattr(config.image, "normalize", True)
        ...
        print(f"CLIP loaded with dimension {self.model.visual.output_dim}")
