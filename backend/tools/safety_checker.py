...
def check_safety(user_query: str, intent: str) -> dict:
    ...
    high_risk_keywords = [
        ...
        # English pesticide / chemical exposure
        "swallowed",
        "drank pesticide",
        "drink pesticide",
        "ate pesticide",
        ...
        # Chinese poison / pesticide / self-harm
        "误食",
        "喝了农药",
        "吞了农药",
        "吃了农药",
    ...
    if any(keyword in text for keyword in high_risk_keywords):
        return {
            "risk_level": "high",
            "reason": "High-risk poison, pesticide, chemical exposure, or self-harm risk detected. Human expert or medical review is required.",
